...
return new class extends Migration
{
    ...
    {
        Schema::create('his_cr', function (Blueprint $table) {
            $table->integer('his_cr_id')->autoIncrement();
            ...
            $table->string('cr_no', 30)->default(null);
            $table->string('cr_name', 255)->default(null);
            $table->string('cr_description', 4000)->default(null);
            $table->integer('cr_progress')->default(null);
            $table->string('cr_status', 10)->default(null);
