...
return new class extends Migration
{
    ...
    {
        Schema::create('mst_cr_detail', function (Blueprint $table) {
            $table->integer('cr_detail_id')->autoIncrement();
    ...
    {
        Schema::dropIfExists('mst_cr_detail');
    }
};
