...
return new class extends Migration
{
    ...
    {
        Schema::create('his_project', function (Blueprint $table) {
            $table->integer('his_project_id')->autoIncrement();
    ...
    {
        Schema::dropIfExists('his_project');
    }
};
